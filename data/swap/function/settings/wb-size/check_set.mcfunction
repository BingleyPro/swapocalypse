...
# Check if it's valid
execute if score _input_value _settings matches ..0 run return run function swap:settings/wb-size/direct_set_invalid
...
return run function swap:settings/wb-size/direct_set_invalid