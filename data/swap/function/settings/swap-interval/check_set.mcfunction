...
# Check if it's valid
execute if score _input_value _settings matches ..0 run return run function swap:settings/swap-interval/direct_set_invalid
...
return run function swap:settings/swap-interval/direct_set_invalid