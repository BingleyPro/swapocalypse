...
# Worldborder size
tellraw @a[tag=op] [{"color":"gold","text":"Worldborder Size: "},{"bold":true,"clickEvent":{"action":"run_command","value":"/function swap:settings/wb-size/adjust_wb_size {input_change:1}"},"color":"red","text":"< "},{"hoverEvent":{"action":"show_text","value":[{"text":"Click to set exact value","color":"green"}]},"nbt":"wb-size","storage":"swap:settings"},{"bold":true,"clickEvent":{"action":"run_command","value":"/function swap:settings/wb-size/adjust_wb_size {input_change:2}"},"color":"green","text":" >"}]
