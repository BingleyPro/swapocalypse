...
execute if score _announce_swap _settings matches 1 run tellraw @a[tag=op] [{"color":"gold","hoverEvent":{"action":"show_text","value":[{"text":"How swap announcements are handled","color":"blue"},{"text":"\n\nClick to set to ","color":"green"},{"text":"Never","color":"gold"}]},"text":"Announce Swap: "},{"hoverEvent":{"action":"show_text","value":[{"text":"Click to change","color":"green"}]},"clickEvent":{"action":"run_command","value":"/function swap:settings/announce-swap/show_dropdown"},"text":"Never","color":"red"}]

execute if score _announce_swap _settings matches 2 run tellraw @a[tag=op] [{"clickEvent":{"action":"run_command","value":"/function swap:settings/announce-swap/set-return {set:1}"},"color":"gold","hoverEvent":{"action":"show_text","value":[{"text":"How swap announcements are handled","color":"blue"},{"text":"\n\nClick to set to ","color":"green"},{"text":"Never","color":"gold"}]},"text":"Announce Swap: "},{"hoverEvent":{"action":"show_text","value":[{"text":"Click to change","color":"green"}]},"clickEvent":{"action":"run_command","value":"/function swap:settings/announce-swap/show_dropdown"},"text":"5 Second Countdown","color":"green"}]
...
execute if score _display_timer _settings matches 1 run tellraw @a[tag=op] [{"color":"gold","hoverEvent":{"action":"show_text","value":[{"text":"How the game timer should be displayed","color":"blue"},{"text":"\n\nClick to set to ","color":"green"},{"text":"No Display","color":"gold"}]},"text":"Timer Display: "},{"hoverEvent":{"action":"show_text","value":[{"text":"Click to change","color":"green"}]},"clickEvent":{"action":"run_command","value":"/function swap:settings/display-timer/show_dropdown"},"text":"No Display","color":"red"}]

execute if score _display_timer _settings matches 2 run tellraw @a[tag=op] [{"clickEvent":{"action":"run_command","value":"/function swap:settings/display-timer/set-return {set:1}"},"color":"gold","hoverEvent":{"action":"show_text","value":[{"text":"How the game timer should be displayed","color":"blue"},{"text":"\n\nClick to set to ","color":"green"},{"text":"No Display","color":"gold"}]},"text":"Timer Display: "},{"hoverEvent":{"action":"show_text","value":[{"text":"Click to change","color":"green"}]},"clickEvent":{"action":"run_command","value":"/function swap:settings/display-timer/show_dropdown"},"text":"Show in Actionbar","color":"green"}]
